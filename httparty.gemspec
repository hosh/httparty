...
Gem::Specification.new do |s|
  ...
  s.description = %q{Makes http fun! Also, makes consuming restful web services dead easy. (Forked version using Merb/JSON gems)}
  ...
  s.summary = %q{Makes http fun! Also, makes consuming restful web services dead easy. (Forked version using Merb/JSON gems)}
